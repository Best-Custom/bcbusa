                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4 class="justify-tab">Manage FAQs</h4>
                            </div>
                        </div>
                    </div>
                    <div class="widget-content widget-content-area justify-tab">
                        ...
                        <ul class="nav nav-tabs  mb-3 mt-3 nav-fill" id="justifyTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="justify-home-tab" data-toggle="tab" href="#justify-home" role="tab" aria-controls="justify-home" aria-selected="true">ADD NEW FAQs</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="justify-profile-tab" data-toggle="tab" href="#justify-profile" role="tab" aria-controls="justify-profile" aria-selected="false">LIST OF FAQs</a>
                            </li>
                        </ul>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-12 col-md-12 col-md-12">
                                            <div class="form-group mb-4">
                                                <label for="formGroupExampleInput">Assign faqs to products</label>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-md-12">
                                            ...
                                            <tbody>
                                                <tr class="create_row_1">
                                                    <td><input name="faq_question" type="text" class="form-control faq_question"></td>
                                                    <td><input name="faq_answer" type="text" class="form-control faq_answer"></td>
                                                    <td><span class="btn btn-danger btn-lg btn-block remove_row" id="row_1">REMOVE</span>
                                                    <span class="btn btn-secondary btn-lg btn-block add_one_more" id="row_1">ADD MORE</span></td>
                                                </tr>
                                            </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="row layout-top-spacing">
                                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                                    <div class="widget-content widget-content-area br-6" style="padding:50px;">
                                        ...
                                        <select class="form-control  basic" id="prod_faq">
                                        <option></option>
                                            @if(!empty($product_list))
                                                @foreach ($product_list as $list)
                                                    <option value="{{$list->id}}">{{$list->prod_title}}</option>
...
$(document).ready(function(){
        ...
        if(errors == 0){
            $.ajax({
                 url:"{{ url('storeprodfaq') }}",
                method:'POST',
                data:{
                        'prod_id':selected_prod_id, 
                        'faq_question':ques.join('|'),
                        'faq_answer':answ.join('|')
                        },
    ...
    $(document).on("change", "#prod_faq", function(e){
		console.clear();
