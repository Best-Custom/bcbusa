                    ...
                    <div class="widget-content widget-content-area justify-tab">
                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="alert alert-success mb-4" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x close" data-dismiss="alert"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button> <strong>Blog Post saved successfully!</strong></div>
                                </div>
                            </div>
                            @endif
                                <form action="{{url('create-blogpost')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-md-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control unique_slug" name="blog_slug" required>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-md-6 col-md-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control" id="blog_tags" name="blog_tags" data-role="tagsinput" id="tags" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-md-12">
                                            <div class="custom-file-container" data-upload-id="myCustomImage">
                                                ...
                                                <label class="custom-file-container__custom-file" >
                                                    <input type="file" name="blog_title_image" class="custom-file-container__custom-file__custom-file-input" accept="image/*" required>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea name="blog_detail_description" class="form-control"></textarea>
                                        </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
