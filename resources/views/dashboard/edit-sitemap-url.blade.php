                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area justify-tab">
                        ...
                        <div class="col-lg-12 col-12 layout-spacing">
                            ...
                            @endif
                                <form action="{{url('update-sitemap-form')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group mb-4">
                                                <label for="loc">Loc</label>
                                                <input type="url" name="loc" class="form-control" value="{{$sitemap_url->loc}}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group mb-4">
                                                <label for="lastmod">lastmod</label>
                                                <input  type="text" name="lastmod" class="form-control basicFlatpickr" value="{{$sitemap_url->lastmod}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <input  type="text" name="changefreq" class="form-control" value="{{$sitemap_url->changefreq}}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group mb-4">
                                                <label for="priority">priority</label>
                                                <input  type="text" name="priority" class="form-control" value="{{$sitemap_url->priority}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-lg-12 col-md-12 col-md-12">
                                            <input type="hidden" name="id" value="{{$sitemap_url->id}}">
