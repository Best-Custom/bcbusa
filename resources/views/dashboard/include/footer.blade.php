    ...
    <script src="{{ asset('dashboard-assets/plugins/table/datatable/datatables.js') }}"></script>
    ...
    <script src="{{ asset('dashboard-assets/plugins/editors/markdown/simplemde.min.js') }}"></script>
    <script src="{{ asset('dashboard-assets/plugins/editors/markdown/custom-markdown.js') }}"></script>
